package com.pinup.barapp.ui.fragments.menu
...
class MenuFragment : Fragment(R.layout.fragment_menu) {
    ...
    private val drinksList = listOf(
        MenuItem(
            1,
            "Pin-up Sunset",
            "Vodka, peach liqueur, cranberry juice, and a splash of soda served over ice.",
            8.99,
            R.drawable.sunset_im
        ),
        MenuItem(
            2,
            "Classic Mojito",
            "White rum, fresh mint, lime juice, sugar, and soda water. Cool and refreshing.",
            9.49,
            R.drawable.mojito_im
        ),
        MenuItem(
            3,
            "Draft Lager",
            "House-brewed golden lager with a crisp finish and creamy head.",
            6.99,
            R.drawable.lager_im
        ),
        MenuItem(
            4,
            "Virgin Berry Fizz",
            "Sparkling berry juice blend with lime and mint. Perfect mocktail option.",
            5.49,
            R.drawable.virgin_berry_fizz_im
        )
    )
    ...
    private val startersList = listOf(
        MenuItem(
            5,
            "Mozzarella Sticks",
            "Golden-fried mozzarella with sauce",
            7.99,
            R.drawable.mozzarella_sticks_im
        ),
        MenuItem(
            6,
            "Loaded Nachos",
            "Chips topped with cheddar & salsa",
            9.49,
            R.drawable.nachos_im
        ),
        MenuItem(
            7,
            "Chicken Bites",
            "Boneless bites with BBQ or buffalo",
            8.99,
            R.drawable.chicken_bites_im
        ),
        MenuItem(
            8,
            "Retro Fries Basket",
            "Fries with cheese dip or spicy ketchup",
            5.99,
            R.drawable.retro_fries_basket_img
        )
    )
    ...
    private val mainsList = listOf(
        MenuItem(
            9,
            "Double Burger",
            "Beef patties, lettuce, sauce",
            13.99,
            R.drawable.double_burger_im
        ),
        MenuItem(
            10,
            "BBQ Chicken Wrap",
            "Grilled chicken, sauce, tortilla",
            11.49,
            R.drawable.chicken_wrap_im
        ),
        MenuItem(
            11,
            "Steak & Fries",
            "Sirloin with fries and garlic butter",
            16.99,
            R.drawable.steak_fries_img
        ),
        MenuItem(
            12,
            "Mac ‘n’ Cheese",
            "Cheddar, mozzarella, crunchy top",
            10.99,
            R.drawable.mac_cheese_im
        )
    )
    ...
    private val dessertsList = listOf(
        ...
        MenuItem(
            ...
            5.49,
            R.drawable.classic_apple_pie_im
        )
    )
